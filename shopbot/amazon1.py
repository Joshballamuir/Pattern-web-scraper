...
class Amazonshop1(unittest.TestCase):
    def setUp(self):
    ...
    def test_amazonshop1(self):
        driver = self.driver
        driver.get(self.base_url + "/")
        driver.find_element_by_id("twotabsearchtextbox").clear()
        driver.find_element_by_id("twotabsearchtextbox").send_keys("cheap")
        ...
        driver.find_element_by_css_selector("#nav-cart > span.nav-line-2").click()
        driver.find_element_by_name("proceedToCheckout").click()
        driver.find_element_by_xpath("(//input[@name='placeYourOrder1'])[3]").click()
