...
while loop == 1:
    ...
    while loop == 1:
        ...
        address = str((ws['{}{}'.format("c",b)].value))
        ...
        url1 = 'https://www.google.co.uk/search?q='+company2+'+'+address1+'+'+'telephone'
        url2 = 'https://www.google.co.uk/search?q='+company2+'+'+'telephone'
        url3 = 'https://www.bing.com/search?q='+company2+'+'+address1+'+'+'telephone'
        url4 = 'https://www.bing.com/search?q='+company2+'+'+'telephone'

        data = requests.get(url1).text+requests.get(url2).text+requests.get(url3).text+requests.get(url4).text
        data1 = data.replace("(", "")
        data2 = data1.replace(")","")
        data3 = data2.replace("-", "")
        datap = data3.replace("+","")
    ...
    #      app package
    #      apply changes to hmrc code
    #      measure average for finding number when only one
