...
while loop == 1:
    ...
    while loop == 1:
        ...
        address = str((ws['{}{}'.format("d",b)].value))
        ...
        postcode = str((ws['{}{}'.format("e",b)].value))
        ...
        url1 = 'https://www.google.co.uk/search?q='+company2+'+'+address1+'+'+'+postcode1+'+telephone'
        url2 = 'https://www.google.co.uk/search?q='+company2+'+'+postcode1+'+'+'telephone'
        url3 = 'https://www.google.co.uk/search?q='+company2+'+'+'telephone'
        url4 = 'https://www.bing.com/search?q='+company2+'+'+address1+'+'+postcode1+'+telephone'
